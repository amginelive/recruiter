    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registered_as', models.CharField(choices=[('c', 'Candidate'), ('a', 'Agent')], default='c', help_text='User role selected during registration', max_length=1, verbose_name='Registered As')),
